...
const ENTRY_CLI_COMMAND_MAP = require('./cli-command-map');
...
function writeEntryFile(completeEntryModel, configModel) {
    ...
    // eslint-disable-next-line max-len
    console.log(chalk.grey(`\n\n* New changelog entry: ${chalk.green(completeEntryModel.generateFileName())} has been added to the entries directory: ${chalk.green(configModel.entriesDir)}. This file should be added to version control. You can edit your entry file at any time.`));
}
